...
/**
 * @author blue&byte
 * @description 亚马逊广告 SD Productads 报表DAO
 * @date 2019/10/31&2021/09/10
 */
public interface SdProductadsReportMapper extends BaseMapper<SpProductadsReport> {
    /**
     ...
     * @Date: 2019/10/31
     **/
    void insertOrUpdateBatch(@Param("list") List<SpProductadsReport> spProductadsReportList);
